...
import { OMNIDEF } from './creditApplicationPOCEnglish_def.js';
import tmpl from './creditApplicationPOCEnglish.html';
import tmpl_nds from './creditApplicationPOCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class creditApplicationPOCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
