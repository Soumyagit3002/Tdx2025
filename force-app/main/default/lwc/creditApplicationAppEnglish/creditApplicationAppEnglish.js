...
import { OMNIDEF } from './creditApplicationAppEnglish_def.js';
import tmpl from './creditApplicationAppEnglish.html';
import tmpl_nds from './creditApplicationAppEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class creditApplicationAppEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
