...
import { OMNIDEF } from './portalApplicationPagesMultiLanguage_def.js';
import tmpl from './portalApplicationPagesMultiLanguage.html';
import tmpl_nds from './portalApplicationPagesMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class portalApplicationPagesMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
