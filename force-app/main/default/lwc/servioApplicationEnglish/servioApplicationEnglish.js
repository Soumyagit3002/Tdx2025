...
import { OMNIDEF } from './servioApplicationEnglish_def.js';
import tmpl from './servioApplicationEnglish.html';
import tmpl_nds from './servioApplicationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class servioApplicationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
