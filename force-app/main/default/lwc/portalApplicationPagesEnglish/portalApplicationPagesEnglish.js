...
import { OMNIDEF } from './portalApplicationPagesEnglish_def.js';
import tmpl from './portalApplicationPagesEnglish.html';
import tmpl_nds from './portalApplicationPagesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class portalApplicationPagesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
